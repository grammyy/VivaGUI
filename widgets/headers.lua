viva.registerWidgets({
    {
        ...
        function(window,self,stack,id)
            hitboxes.create(window,3,table.address(window)..id,window.x+stack.x*0.7,window.y+stack.y*0.7,window.width-style.windowPadding[1]-6,11.2,function()
                ...
                render.drawRoundedBox(stack.style and stack.style.frameRounding or style.frameRounding,stack.x,stack.y,window.width/0.7-style.windowPadding[1]-6,16)
            end)
